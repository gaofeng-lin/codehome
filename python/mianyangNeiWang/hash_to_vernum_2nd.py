...
for j in os.listdir('C:/Users/Administrator/Desktop/name_split'):
# 哈希值和版本号对应的关系的文件路径
    f=open('C:/Users/Administrator/Desktop/version_hash_try.txt')
    ...
    # 获得每个文件夹里面的内容
    filelist=os.listdir('C:/Users/Administrator/Desktop/name_split/'+j)
    n=0

    # print filelist  no error

    for filenames in os.listdir('C:/Users/Administrator/Desktop/name_split/'+j):
        # print filenames
        new_line=re.sub('\.',str(filenames))
        # print(new_line)
    ...
    for i in filelist:
        ...
        oldname='C:/Users/Administrator/Desktop/name_split/'+j+'/'+filelist[n]
        ...
        if new_list[-1] in dict.keys():
            ...
            # 替换完成后存放的路径
            newname='C:/Users/Administrator/Desktop/name_split2/'+j+'/'+'cfd_para_'+value+'.txt'
