...
def get_value_name(file_path):
    ...
    while line:
        ...
        if len(new_line1)==2:
            ...
            list_end.append(new_line_value_num[0].strip())
...
if __name__=='__main__':
    old_version_list=get_value_name('C:/Users/Administrator/Desktop/try1/cfd_para_7575.txt')
    new_version_list=get_value_name('C:/Users/Administrator/Desktop/try1/cfd_para_8388.txt')

    print(len(new_version_list))