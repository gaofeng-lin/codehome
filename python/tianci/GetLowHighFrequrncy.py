...
if __name__ == '__main__':
    ...
    img = pd.read_csv('./dataBase/origin_data.csv').values
    
    print('img  is : ', img.shape)

    # img = cv2.imread('/Users/smm/WorkPlace/PythonProject/motivation/RT7/0450.png', cv2.IMREAD_GRAYSCALE)
    low_freq_part_img, high_freq_part_img = get_low_high_f(img, radius_ratio=radius_ratio, D=D)  # multi channel or single
 

    print('low_freq_part_img: ', low_freq_part_img.shape)
    print('high_freq_part_img: ', high_freq_part_img.shape)
