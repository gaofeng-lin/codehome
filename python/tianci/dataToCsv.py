...
new_frame_data = np.load("C:\\Users\\76585\\Desktop\\天池结果文件v2\\dataExtension\\selected_data.npy")



# print(origin_frame_data)
...
# 文件路径
filename = "C:\\Users\\76585\\Desktop\\天池结果文件v2\\dataExtension\\data.csv"

# 检查文件是否存在，如果不存在则写入标题行
if not os.path.exists(filename):
    with open(filename, 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(['x', 'y', 't', 'ux', 'uy', 'p'])
